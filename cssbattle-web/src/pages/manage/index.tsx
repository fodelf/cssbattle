 ...
 * @LastEditors: 吴文周
 * @LastEditTime: 2021-10-11 08:59:26
 */
    ...
    <Row className={styles.manageContent}>
      <Col span={3} className={styles.manageLeft}>
        <ul className={styles.list}>
          <li
            className={
              props.location.pathname.includes('cssManage') ? styles.active : ''
            }
            onClick={() => clickMenu('cssManage')}
          >
            CSS管理
          </li>
          <li
            className={
              props.location.pathname.includes('pratiseManage')
                ? styles.active
                : ''
            }
            onClick={() => clickMenu('pratiseManage')}
          >
            题目管理
          </li>
        </ul>
      ...
      <Col span={21} className={styles.manageRight}>
        <Breadcrumb>
          ...
          <Breadcrumb.Item onClick={() => history.push('/index/manage')}>
            面试列表
          </Breadcrumb.Item>
