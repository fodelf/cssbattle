 ...
 * @LastEditors: pym
 * @LastEditTime: 2021-10-07 16:14:22
 */
    ...
    <Row className={styles.manageContent}>
      <Col span={3}  className={styles.manageLeft}>
        <ul className={styles.list}>
          <li className={current === 'cssManage' ?styles.active:''} onClick={()=>clickMenu('cssManage')}>CSS管理</li>
          <li className={current === 'pratiseManage' ?styles.active:''} onClick={()=>clickMenu('pratiseManage')}>练习管理</li>
        </ul>
      </Col>
